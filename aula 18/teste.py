...
janela.configure(bg =  '#EE4949')


texto = tk.Label(janela, text='SEU TEXTO AQUI', fg = 'white', font = ('Montserrat', 32), bg ='#EE4949' )
texto.pack(pady=75)
...
mostrar_texto =  tk.Label(janela, text = 'aqui vai mostrar um texto', bg ='#EE4949', fg = 'white', font = ('Montserrat', 25))
